...
const PageLoader: React.FC = () => {
  return (
    <div className="flex flex-col justify-center items-center h-full text-5xl text-purple-light">
      <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="max-w-xl">
        <linearGradient
          id="linear-gradient"
        ...
        <linearGradient
          ...
          y2="71.693"
        />
        <linearGradient id="linear-gradient-3" x1={297} x2={297} xlinkHref="#linear-gradient" y1="490.5" y2="71.693" />
        <linearGradient id="linear-gradient-4" x1={221} x2={221} xlinkHref="#linear-gradient" y1="490.5" y2="71.693" />
        <linearGradient
        ...
        <path
          d="m258.578 64.2a38.374 38.374 0 0 0 -36.911 26.6 6 6 0 0 0 11.384 3.8c4.522-13.565 16.151-18.4 25.527-18.4s21 4.834 25.526 18.4a6 6 0 0 0 11.383-3.8 38.372 38.372 0 0 0 -36.909-26.6z"
