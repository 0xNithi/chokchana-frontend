...
const Register: React.FC = () => {
  ...
  const RegisterSchema = Yup.object().shape({
    ...
    idNumber: Yup.string()
      .min(13, 'โปรดกรอกรหัสบัตรประชาชน 13 หลัก')
      .max(13, 'โปรดกรอกรหัสบัตรประชาชน 13 หลัก')
      .matches(/^[0-9]{13}$/, 'รหัสบัตรประชาชนต้องเป็นตัวเลขเท่านั้น')
      .matches(/^[1-9]{1}[0-9]{12}$/, 'รหัสบัตรประชาชนต้องเริ่มที่ 1 - 9 เท่านั้น')
