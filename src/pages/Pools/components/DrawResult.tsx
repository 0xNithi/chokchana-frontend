...
const PastDraw: React.FC<Props> = ({ round }) => {
  ...
  return (
    <Card className="grid grid-cols-12 font-semibold mx-16">
      <div className="col-span-12 md:col-span-7 flex flex-col space-y-4 p-4">
        ...
        <div className="mx-auto">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col">
              <div className="text-base text-purple dark:text-purple-lightest">อันดับ 1</div>
          ...
          <div className="flex items-center space-x-4">
            <img src="/images/thb-token.png" alt="ticket" className="w-20" />
            <div className="flex flex-col">
              <div className="text-base text-purple dark:text-purple-lightest">เงินรางวัล</div>
              <div className="text-2xl text-purple dark:text-white">{(1000000).toLocaleString('en-US')}</div>
            </div>
          </div>
        </div>
      </div>
      <div className="col-span-12 md:col-span-5 p-8 bg-gray-light dark:bg-purple m-4 rounded-xl space-y-4">
        <div className="text-purple dark:text-purple-light text-xl text-center">รางวัลอื่นๆ</div>
        <Divider />
        <div className="flex justify-around">
          <div className="flex flex-col items-center">
            <div className="text-xl text-purple-light">อันดับ 2</div>
            <div className="text-xl text-purple dark:text-white">
              {secondWinner ? (formatUnits(secondWinner[0], 0).replace('.0', '') + '').padStart(4, '0') : 'Loading...'}
            </div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-xl text-purple-light">อันดับ 3</div>
            <div className="text-xl text-purple dark:text-white">
